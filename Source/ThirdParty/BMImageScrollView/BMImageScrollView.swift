...
open class BMImageScrollView: UIScrollView {
    ...
    private func initialize() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(BMImageScrollView.changeOrientationNotification), name: UIDevice.orientationDidChangeNotification, object: nil)
    }
    ...
    @objc open func display(image: UIImage) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(BMImageScrollView.doubleTapGestureRecognizer(_:)))
    ...
    @objc func doubleTapGestureRecognizer(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if zoomScale >= minimumZoomScale * BMImageScrollView.kZoomInFactorFromMinWhenDoubleTap - 0.01 {
            setZoomScale(minimumZoomScale, animated: true)
        } else {
            let center = gestureRecognizer.location(in: gestureRecognizer.view)
            let zoomRect = zoomRectForScale(BMImageScrollView.kZoomInFactorFromMinWhenDoubleTap * minimumZoomScale, center: center)
...
extension BMImageScrollView: UIScrollViewDelegate {
