...
//        let activityIndicatorView : DGActivityIndicatorView = DGActivityIndicatorView.init(type: DGActivityIndicatorAnimationType(rawValue: 8)!, tintColor: AppTheme.Color.primaryTheme, size:width)
//        activityIndicatorView.center = viewObj.center
