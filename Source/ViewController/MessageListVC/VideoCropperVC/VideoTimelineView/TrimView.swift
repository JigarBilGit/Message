...
class TrimView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        var color = MessageTheme.Color.primaryTheme //UIColor(hue: 0.1, saturation:0.8, brightness:1, alpha: 1)
        let outColor = MessageTheme.Color.primaryTheme //UIColor(hue: 0.1, saturation:0.8, brightness:1, alpha: 0.3)
